      ...
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            const CircleAvatar(
              radius: 80,
              backgroundImage: AssetImage('assets/indra.jpeg'),
            ),
                ...
                child: Column(
                  children: <Widget>[
                    ListTile(
                      ...
                      subtitle: const Text('16 November 2002'),
                    ),
                    Divider(color: Colors.grey.shade300, thickness: 1),
                    ListTile(
                      leading: const Icon(Icons.web, color: Colors.blue),
                      title: const Text('Website'),
                      subtitle: const Text('future-techindustries.com'),
                      onTap: () {},
                    ),
                    Divider(color: Colors.grey.shade300, thickness: 1),
                    ListTile(
                      ...
                      subtitle: const Text('indracahyomaulana@gmail.com'),
                    ),
                    Divider(color: Colors.grey.shade300, thickness: 1),
                    ListTile(
            ...
            _buildInformationCard(context, 'Hobbies', [
              ...
              _buildListTile(Icons.directions_bike, 'Game', 'Mobile Legends'),
              _buildListTile(Icons.movie, 'Film', 'Avangers'),
            ]),
            const SizedBox(height: 20),
            Row(
